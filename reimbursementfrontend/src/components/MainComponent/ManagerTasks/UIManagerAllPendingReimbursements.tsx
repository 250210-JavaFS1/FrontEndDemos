...
import { ManagerAllPendingReimbursement } from "./ManagerAllPendingReimbursement"


export const UIManagerAllPendingReimbursements:React.FC=()=>{
  ...
  const handleLogout = () => {
    ...
    >
      ...
      <Row>
      <ManagerAllPendingReimbursement/>
      </Row>
